...
console.log('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: populatedb mongodb+srv://rajesh:1234@cluster0.rxmetts.mongodb.net/my_library?retryWrites=true&w=majority');
...
function createGenreAuthors(cb) {
    async.series([
        function(callback) {
          authorCreate('Abc', 'Def', '1997-06-06', false, callback);
        },
        function(callback) {
          authorCreate('Cba', 'Fed', '2000-11-8', false, callback);
        },
        ],
        // optional callback
        cb);
